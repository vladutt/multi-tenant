                                ...
                                <div>
                                    ...
                                    <div class="social-login-buttons flex flex-wrap items-center mt-4">
                                        ...
                                        <div class="bg-facebook pt-3 pb-2 px-4 rounded-lg cursor-pointer mr-4">
                                            <svg aria-hidden="true" class="text-white h-4 w-4 svg-inline--fa fa-facebook-f fa-w-9" data-icon="facebook-f"
                                                 data-prefix="fab"
                                                 focusable="false"
                                                 role="img" viewBox="0 0 264 512" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="bg-twitter pt-3 pb-2 px-4 rounded-lg cursor-pointer mr-4">
                                            <svg aria-hidden="true" class="text-white h-4 w-4 svg-inline--fa fa-twitter fa-w-16" data-icon="twitter"
                                                 data-prefix="fab"
                                        ...
                                        <div class="bg-google pt-3 pb-2 px-4 rounded-lg cursor-pointer mr-4">
                                            <svg aria-hidden="true" class="text-white h-4 w-4 svg-inline--fa fa-google fa-w-16" data-icon="google"
                                                 data-prefix="fab"
                                                 focusable="false" role="img"
                                        ...
                                        <div class="bg-github pt-3 pb-2 px-4 rounded-lg cursor-pointer mr-4">
                                            <svg aria-hidden="true" class="text-white h-4 w-4 svg-inline--fa fa-github-alt fa-w-15" data-icon="github-alt"
                                                 data-prefix="fab"
                                                 focusable="false"
                                                 role="img" viewBox="0 0 480 512" xmlns="http://www.w3.org/2000/svg">
    ...
    methods: {
        login() {
            this.$http.post('/login', {
                ...
                window.Laravel.checkLogin = true;
